...
_console.prototype.log = function(obj) {
    _API_process.stdout.write((obj !== undefined ? (obj !== null ? (
...
module.exports = {
    ...
    __init_script: function(filename) {
        ...
        if(filename) {
            ...
            module.exports.module.filename = module.exports.module.id = filename;
            module.exports.module.paths = _module._nodeModulePaths(module.exports.__dirname);
        }

        module.exports.module.loaded = true;
        module.exports.require = makeRequire(module.exports.module);
    }
};
